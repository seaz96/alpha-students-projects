...
namespace StudentProjects.DataLayer.Data.Migrations
{
    ...
    [Migration("20251215192647_Files")]
    partial class Files
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectUser", b =>
                {
                    b.Property<Guid>("MentorProjectsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("MentorsId")
                        .HasColumnType("uuid");

                    b.HasKey("MentorProjectsId", "MentorsId");
            ...
            modelBuilder.Entity("StudentProjects.Domain.Entities.FileObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProjectUser", b =>
                {
                    b.HasOne("StudentProjects.Domain.Entities.Project", null)
                        .WithMany()
                        .HasForeignKey("MentorProjectsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudentProjects.Domain.Entities.User", null)
                        .WithMany()
